...
(ert-deftest dumb-jump--extract-qualifier-test ()
  ...
  (should (string= (dumb-jump--extract-qualifier '(:left "Foo.Bar." :right "()"))
                    "Bar"))
  (should (null (dumb-jump--extract-qualifier '(:left "x = " :right "()"))))
  (should (null (dumb-jump--extract-qualifier '(:left "" :right "()"))))
  (should (null (dumb-jump--extract-qualifier '(:left nil :right "()")))))
